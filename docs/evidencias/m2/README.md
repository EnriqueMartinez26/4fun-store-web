...
| **Paso 2**  | Registro y Login      | [test-register-flow.js](file:///d:/Programación/Proyectos/Facultad/tesis/4fun-store-api/scripts/test-register-flow.js)                                                                                                                                                                  |   Test Script   | Alta de usuario, verificación de email y login posterior con sesión autenticada.                                                |
