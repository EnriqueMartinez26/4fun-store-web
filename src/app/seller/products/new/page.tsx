    ...
    <div className="max-w-4xl mx-auto py-12 px-4 space-y-8 animate-in fade-in duration-700">
      <div className="flex items-center justify-between">
        <Button
          variant="ghost"
          asChild
          className="hover:bg-primary/10 hover:text-primary font-bold text-xs uppercase tracking-widest"
        >
          ...
          <Card className="border-none bg-card/40 backdrop-blur-3xl shadow-2xl rounded-[4px] overflow-hidden">
            <CardHeader className="p-10 border-b border-white/5 bg-primary/5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <CardTitle className="text-2xl font-headline font-black italic">
                    Crear Publicación
                  </CardTitle>
                  <CardDescription className="text-[10px] font-black uppercase tracking-widest opacity-60">
                    Completá los datos de tu nueva oferta
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
                ...
                <form onSubmit={vm.onSubmit} className="space-y-8">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="space-y-3">
                        ...
                        <FormControl>
                          <Textarea
                            placeholder="Contale a los compradores de qué trata el juego..."
                        ...
                        <FormItem className="space-y-3">
                          ...
                          <FormControl>
                            <Input
                              type="number"
                              step="0.01"
                              className="h-14 bg-white/5 border-white/10 rounded-2xl font-black text-primary"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center px-2">
                      ...
                      <Badge
                        variant="outline"
                        className="text-[9px] font-black tracking-widest bg-primary/5 border-primary/20"
                      >
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            <FormControl>
                              <SelectTrigger className="h-14 bg-white/5 border-white/10 rounded-2xl">
                                <SelectValue
                                  placeholder={
                                    vm.isLoadingTaxonomies ? 'Cargando...' : 'Seleccionar'
                                  }
                                />
                              </SelectTrigger>
                            </FormControl>
                      ...
                      <FormItem className="flex flex-row items-center space-x-4 space-y-0 rounded-[4px] border border-white/5 p-6 bg-white/5">
                        ...
                        <div className="space-y-1">
                          <FormLabel className="text-xs font-bold uppercase tracking-widest">
                            Activar Oferta Inicial
                          </FormLabel>
                          <FormDescription className="text-[9px] uppercase font-bold tracking-widest opacity-40">
                            Lanzá el producto con un precio promocional.
                          </FormDescription>
                        </div>
                      </FormItem>
                    )}
                          ...
                          <FormItem className="space-y-3">
                            ...
                            <FormControl>
                              <Input
                                ...
                                min="0"
                                max="100"
                                className="h-14 bg-white/5 border-white/10 rounded-2xl font-black text-green-400"
                                {...field}
                              />
                            </FormControl>
                            <FormMessage />
                      ...
                      <div className="p-6 rounded-[4px] bg-green-500/10 border border-green-500/20 flex items-center justify-between">
                        <div className="space-y-1">
                          ...
                          <div className="flex items-baseline gap-3">
                            <span className="text-2xl font-black text-green-400">
                              $
                              {(
                                Number(vm.form.watch('price') || 0) *
                                (1 - Number(vm.form.watch('discountPercentage') || 0) / 100)
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-sm font-black text-green-400">
                            ...
                            {(
                              Number(vm.form.watch('price') || 0) *
                              (Number(vm.form.watch('discountPercentage') || 0) / 100)
                        ...
                        {vm.isCustomDev ? (
                          <div className="flex gap-2">
                            ...
                            <Button
                              ...
                              onClick={vm.cancelCustomDeveloper}
                            >
                              CANCELAR
                            </Button>
                          </div>
                          ...
                          <Select
                            onValueChange={vm.toggleCustomDeveloper}
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center space-x-4 space-y-0 rounded-[4px] border border-primary/20 p-6 bg-primary/5">
                        ...
                        <div className="space-y-1">
                          ...
                          <FormDescription className="text-[9px] uppercase font-bold tracking-widest opacity-60">
                            Si se marca, el producto estará disponible en el catálogo
                            inmediatamente.
                          </FormDescription>
                        </div>
                      </FormItem>
                  ...
                  <Button
                    type="submit"
                    className="w-full h-16 bg-primary text-white font-bold text-lg tracking-widest rounded-[4px] shadow-xl hover:shadow-[0_15px_40px_rgba(214,88,250,0.4)] hover:-translate-y-1 transition-all"
                    disabled={vm.isSubmitting || vm.isUploading}
                  >
                    {vm.isSubmitting ? (
                      <Loader2 className="h-6 w-6 animate-spin" />
                    ) : (
                      <>
                        <PlusCircle className="mr-3 h-6 w-6" /> CREAR PUBLICACIÓN
                      </>
                    )}
                  </Button>
                </form>
            ...
            <CardContent className="p-8 space-y-6">
              <div className="relative group">
                <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-white/10 bg-black/40 shadow-inner">
                  ...
                  {vm.form.watch('imageId') && (
                    <Button
                      ...
                      onClick={() => vm.form.setValue('imageId', '')}
                    >
                      <X className="h-5 w-5" />
                    </Button>
                  )}
                ...
                <div className="mt-6">
                  ...
                  />
                  <p className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground mt-3 text-center">
                    Formato Vertical Recomendado (3:4)
                  </p>
                </div>
              </div>
            </CardContent>
