                ...
                <form onSubmit={vm.onSubmit} className="space-y-8">
                      ...
                      render={({ field }) => (
                        <FormItem className="space-y-3">
                          ...
                          <FormControl>
                            <Input
                              type="number"
                              disabled={vm.form.watch('type' as any) === 'Digital'}
                      ...
                      <FormItem className="flex flex-row items-center space-x-4 space-y-0 rounded-[2rem] border border-white/5 p-6 bg-white/5">
                        ...
                        <div className="space-y-1">
                          ...
                          <FormDescription className="text-[9px] uppercase font-bold tracking-widest opacity-40">
                            Aplica un descuento porcentual inmediato.
                          </FormDescription>
                        </div>
                      </FormItem>
                    )}
                      ...
                      <FormItem className="flex flex-row items-center space-x-4 space-y-0 rounded-[2rem] border border-primary/20 p-6 bg-primary/5">
                        ...
                        <div className="space-y-1">
                          ...
                          <FormDescription className="text-[9px] uppercase font-bold tracking-widest opacity-60">
                            Si está marcado, el producto será visible para todos los compradores.
                          </FormDescription>
                        </div>
                      </FormItem>
                    )}
                  ...
                  >
                    {vm.isSubmitting ? (
                      ...
                      <>
                        <Save className="mr-3 h-6 w-6" /> GUARDAR CAMBIOS
                      </>
                    )}
                  </Button>
                </form>
