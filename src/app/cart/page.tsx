  ...
  if (!user) {
    return (
      <div className="container mx-auto max-w-screen-lg px-4 py-32 text-center animate-in fade-in zoom-in-95 duration-700">
        ...
        <h2 className="text-3xl font-headline text-white font-bold mb-2 italic">Iniciá Sesión</h2>
  ...
  return (
    <div className="container mx-auto max-w-screen-xl px-4 py-20 animate-in fade-in duration-1000">
      <div className="flex items-center justify-between mb-12 border-b border-white/5 pb-8 sticky top-[4.5rem] z-30 bg-background/80 backdrop-blur-xl pt-4 -mt-4">
        <div>
          <h1 className="text-5xl font-bold font-headline text-white/60 tracking-tighter italic uppercase drop-shadow-md">
            Tu Carrito
          </h1>
        </div>
      </div>
      ...
      {cart.length === 0 ? (
        <div className="text-center py-24 bg-card/10 backdrop-blur-3xl border-2 border-dashed border-white/5 rounded-[4px] animate-in zoom-in-95 duration-700">
          ...
          <p className="mt-4 text-muted-foreground max-w-sm mx-auto text-sm">
            Todavía no agregaste productos a tu carrito. Explorá nuestro catálogo para encontrar tus
            juegos favoritos.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-8 space-y-4">
            {cart.map((item) => {
              ...
              return (
                <Card
                  key={item.id}
                  className="group relative flex items-center p-6 border-none bg-card/40 backdrop-blur-3xl rounded-3xl overflow-hidden hover:bg-card/60 transition-all duration-500 shadow-xl ring-1 ring-white/5"
                >
                  ...
                  <div className="ml-6 flex-1 pr-4">
                    ...
                    <h3 className="font-headline text-xl font-semibold text-white group-hover:text-primary transition-colors">
                      {itemName}
                    </h3>
                    <p className="text-lg font-bold mt-2 text-white/90 tabular-nums tracking-tighter">
                      {asCurrencySafe(safePrice)}
                    </p>
                  </div>
          ...
          <div className="lg:col-span-4 sticky top-24">
            <Card className="border-none bg-primary/5 backdrop-blur-3xl shadow-3xl rounded-[4px] overflow-hidden ring-1 ring-primary/20">
              <CardHeader className="bg-primary/10 py-10 px-10 text-center border-b border-primary/10">
                <CardTitle className="font-headline text-2xl font-semibold text-white tracking-widest uppercase">
                  Resumen de Compra
                </CardTitle>
              </CardHeader>
              <CardContent className="p-10 space-y-8">
                ...
                <div className="flex justify-between items-end">
                  ...
                  <span className="text-4xl font-bold text-white/60 tracking-tighter tabular-nums">
                    {formatCurrency(cartTotal)}
                  </span>
                </div>
              </CardContent>
