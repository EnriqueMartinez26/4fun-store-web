...
function RegisterForm() {
  ...
  return (
    <div className="container mx-auto flex flex-col items-center justify-center min-h-[90vh] py-12 px-4 animate-in fade-in zoom-in-95 duration-700">
      <Card className="w-full max-w-lg border-none bg-card/40 backdrop-blur-3xl shadow-3xl rounded-[4px] overflow-hidden ring-1 ring-white/10 relative">
        {/* Adorno Top gradient */}
        ...
        <CardContent className="px-6 md:px-10 pb-8">
          <Form {...form}>
            <form onSubmit={onSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full h-14 bg-white/5 text-white hover:bg-primary/10 hover:text-primary border border-white/10 hover:border-primary font-black uppercase text-xs tracking-[0.15em] rounded-2xl shadow-xl hover:shadow-primary/20 transition-all duration-300 group mt-4"
                disabled={isSubmitting}
              >
                {isSubmitting ? (
                  <>
        ...
        <CardFooter className="flex flex-col space-y-6 text-center px-10 pb-10 mt-2">
          <div className="text-sm text-muted-foreground/80 font-medium tracking-tight">
            ...
            >
              <ArrowLeft className="h-4 w-4 group-hover:-translate-x-1.5 transition-transform text-primary" />{' '}
