...
export default function PendingPage() {
  ...
  return (
    <div className="container flex items-center justify-center min-h-[85vh] px-4 animate-in fade-in zoom-in-95 duration-700">
      <Card className="w-full max-w-lg border-none bg-card/40 backdrop-blur-3xl shadow-3xl rounded-[4px] overflow-hidden ring-1 ring-white/10">
        <CardHeader className="pt-12 pb-6 text-center">
          ...
          <p className="text-[10px] font-black uppercase tracking-[0.3em] text-yellow-400/80 mt-2">
            Acreditación Asíncrona Pendiente
          </p>
        </CardHeader>
        <CardContent className="space-y-8 px-10 pb-12 text-center">
          <div className="space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              Su orden ha sido registrada correctamente. Estamos aguardando la confirmación de la
              pasarela para liberar sus activos digitales.
            </p>
            <div className="bg-yellow-500/5 border border-yellow-500/10 p-5 rounded-2xl flex items-start gap-4 text-left">
              ...
              <p className="text-xs text-yellow-100/70 font-medium leading-relaxed">
                Si utilizó medios de pago en efectivo (ej: Rapipago/Pagofácil), la acreditación
                puede demorar de 24 a 48 horas hábiles según normativas bancarias.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <Button
              asChild
              size="lg"
              className="h-14 bg-yellow-600 text-white hover:bg-yellow-700 font-black uppercase text-[10px] tracking-widest transition-all rounded-xl shadow-xl shadow-yellow-600/20"
            >
              <Link href="/account">
            ...
            <Link
              href="/productos"
              className="text-[10px] font-black text-muted-foreground uppercase tracking-widest hover:text-white transition-colors flex items-center justify-center gap-2 group"
            >
              Explorar otros Activos{' '}
