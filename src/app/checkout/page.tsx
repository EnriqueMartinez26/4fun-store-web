  ...
  if (cart.length === 0) {
    return (
      <div className="container mx-auto py-32 text-center animate-in fade-in zoom-in-95 duration-700 px-4">
        ...
        <h1 className="text-4xl font-headline font-semibold mb-4 text-white tracking-tight">
          Carrito Vacío
        </h1>
        <p className="text-muted-foreground mb-10 text-sm uppercase tracking-widest font-medium opacity-60">
                ...
                <Card className="border-none bg-card/40 backdrop-blur-3xl shadow-3xl rounded-[2.5rem] overflow-hidden">
                  <CardHeader className="pt-10 px-10">
                    ...
                    <CardDescription className="text-xs">
                      Completa la información para recibir tus productos.
                    </CardDescription>
                  </CardHeader>
                ...
                <Card className="border-none bg-card/40 backdrop-blur-3xl shadow-3xl rounded-[2.5rem] overflow-hidden">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <div>
                            <p className="font-bold text-white uppercase tracking-widest text-[11px]">
                              Mercado Pago
                            </p>
                          ...
                          <Badge
                            variant="outline"
                            className="ml-auto text-[10px] border-white/10 text-muted-foreground font-black uppercase tracking-widest"
                          >
                            Enlace Certificado
                          </Badge>
                        </Label>
                  ...
                  <CardFooter className="bg-white/5 px-10 py-6 flex justify-between">
                    <Button
                      variant="ghost"
                      onClick={prevStep}
                      className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground hover:text-white transition-all"
                    >
              ...
              >
                <Card className="border-none bg-card/40 backdrop-blur-3xl shadow-3xl rounded-[2.5rem] overflow-hidden">
                  <CardHeader className="pt-10 px-10">
                    ...
                    <CardDescription className="text-xs text-muted-foreground">
                      Revisa los datos antes de finalizar el pedido.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="px-10 pb-10 space-y-10">
                    ...
                    <div className="bg-destructive/5 border border-destructive/20 p-6 rounded-2xl text-center">
                      <p className="text-[10px] font-black uppercase tracking-widest text-destructive mb-2">
                        Advertencia Legal
                      </p>
                      <p className="text-xs text-muted-foreground leading-relaxed">
                        Al proceder, usted autoriza la generación de la orden técnica y su posterior
                        liquidación vía pasarela. Se aplicarán los términos de servicio vigentes.
                      </p>
                    </div>
                  </CardContent>
                ...
                {cart.map((item) => (
                  <div key={item.id} className="flex justify-between items-start text-xs group">
                    <div className="space-y-1">
                      <p className="text-white font-bold transition-colors group-hover:text-primary">
                        {item.name}
                      </p>
                      <p className="text-[10px] text-muted-foreground uppercase font-black tracking-widest">
                        {item.quantity} Unidad(es) x {formatCurrency(item.price)}
                      </p>
                    </div>
