    ...
    <div className="container flex items-center justify-center min-h-[85vh] px-4 animate-in fade-in zoom-in-95 duration-700">
      <Card className="w-full max-w-lg border-none bg-card/40 backdrop-blur-3xl shadow-3xl rounded-[4px] overflow-hidden ring-1 ring-white/10">
        <CardHeader className="pt-12 pb-6 text-center">
          ...
          <p className="text-[10px] font-black uppercase tracking-[0.3em] text-destructive/80 mt-2">
        ...
        <CardContent className="space-y-8 px-10 pb-12 text-center">
          <div className="space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              No se ha podido procesar la liquidación en la entidad financiera. No se han efectuado
              débitos ni cargos a su cuenta.
            </p>
            <div className="bg-destructive/5 border border-destructive/10 p-4 rounded-xl">
              <p className="text-[10px] font-bold text-destructive uppercase tracking-widest italic">
                Causa probable: Fondos insuficientes o fallo en validación 3DS.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <Button
              asChild
              size="lg"
              className="h-14 bg-destructive text-white hover:bg-destructive/90 font-black uppercase text-[10px] tracking-widest transition-all rounded-xl shadow-xl shadow-destructive/20"
            >
              <Link href="/checkout">
            ...
            <Button
              variant="ghost"
              asChild
              className="h-12 font-black uppercase text-[10px] tracking-widest text-muted-foreground hover:text-white transition-all"
            >
              <Link href="/contacto">
