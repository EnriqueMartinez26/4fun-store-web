    ...
    <div className="min-h-screen bg-background p-8 md:p-16 space-y-16 animate-in fade-in duration-1000">
      ...
      <header className="max-w-4xl space-y-6">
        ...
        <p className="text-xl md:text-2xl text-muted-foreground font-sans leading-relaxed max-w-2xl">
          Experimentá una identidad visual unificada con la legibilidad cristalina de{' '}
          <span className="text-white font-bold">Inter</span>. Diseñado para ofrecer una experiencia
          gamer coherente y profesional.
        </p>
        <div className="flex gap-4 pt-4">
          <Button
            size="lg"
            className="h-14 px-8 rounded-full text-base font-black uppercase tracking-widest shadow-lg shadow-primary/20"
          >
          ...
          <Button
            size="lg"
            variant="outline"
            className="h-14 px-8 rounded-full text-base font-black uppercase tracking-widest border-white/10 hover:bg-white/5"
          >
            Leer Documentación
          </Button>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <Card className="lg:col-span-2 border-none bg-gradient-to-br from-primary/10 via-card/50 to-background shadow-2xl relative overflow-hidden group">
          ...
          <CardHeader className="p-8">
            ...
            <CardTitle className="text-4xl font-headline font-black text-white mb-2">
              Elden Ring: Shadow of the Erdtree
            </CardTitle>
            <CardDescription className="text-lg text-muted-foreground italic">
              &ldquo;Un viaje épico que redefine los límites de la fantasía oscura.&rdquo;
            </CardDescription>
          </CardHeader>
          ...
          <CardFooter className="p-8 border-t border-white/5 bg-white/5">
            <Button className="w-full h-12 text-sm font-black uppercase tracking-[0.2em]">
              Añadir al carrito
            </Button>
          </CardFooter>
        </Card>
              ...
              {[1, 2].map((i) => (
                <div key={i} className="space-y-2">
                  <div className="flex gap-1">
                    {[...Array(5)].map((_, idx) => (
                      <Star key={idx} className="h-3 w-3 text-yellow-500 fill-yellow-500" />
                    ))}
                  </div>
                  <p className="text-xs text-white/70 italic leading-relaxed">
                    &ldquo;Este juego es simplemente increíble. El diseño artístico es superior y la
                    tipografía Outfit se ve genial en la interfaz.&rdquo;
                  </p>
                </div>
              ))}
            </CardContent>
      ...
      <section className="space-y-6 text-center lg:text-left">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground font-sans">
            Muestra de legibilidad en tablas de alto volumen de datos.
          </p>
        </div>
          ...
          <Table>
            <TableHeader className="bg-muted/30">
              <TableRow className="border-white/5 hover:bg-transparent">
                <TableHead className="py-5 font-black uppercase tracking-[0.2em] text-[10px] text-muted-foreground pl-8">
                  ID Transacción
                </TableHead>
                <TableHead className="py-5 font-black uppercase tracking-[0.2em] text-[10px] text-muted-foreground">
                  Usuario
                </TableHead>
                <TableHead className="py-5 font-black uppercase tracking-[0.2em] text-[10px] text-muted-foreground">
                  Estado
                </TableHead>
                <TableHead className="py-5 font-black uppercase tracking-[0.2em] text-[10px] text-muted-foreground text-right pr-8">
                  Valor Neto
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {[
                ...
                >
                  <TableCell className="py-4 font-mono text-xs text-muted-foreground pl-8">
                    #{row.id}
                  </TableCell>
                  <TableCell className="py-4 font-bold text-white text-sm uppercase">
                    {row.user}
                  </TableCell>
      ...
      <footer className="flex flex-col md:flex-row items-center justify-between border-t border-white/5 pt-12 pb-24 gap-8">
        <div className="flex items-center gap-6">
          <Button variant="ghost" className="text-muted-foreground hover:text-white group">
            <Download className="mr-2 h-4 w-4 group-hover:scale-110 transition-transform" /> Versión
            PDF
          </Button>
          <Button variant="ghost" className="text-muted-foreground hover:text-white group">
            <Share2 className="mr-2 h-4 w-4 group-hover:scale-110 transition-transform" /> Compartir
            Proyecto
          </Button>
        </div>
