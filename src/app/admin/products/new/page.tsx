  ...
  const onSubmit = async (data: AdminProductBaseValues) => {
    try {
      ...
      toast({
        ...
        description: 'El producto fue agregado al catálogo correctamente.',
      });
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="space-y-3">
                        ...
                        <FormControl>
                          <Textarea
                            placeholder="Contá de qué se trata el juego..."
                            className="min-h-[140px] bg-white/5 border-white/10 rounded-2xl leading-relaxed"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                        ...
                        {isCustomDev ? (
                          <div className="flex gap-3">
                            ...
                            <Button
                              type="button"
                              variant="outline"
                              className="border-white/10 h-14 rounded-2xl px-6 font-bold"
                              onClick={() => {
                ...
                {form.watch('imageId') ? (
                  <>
                    ...
                    <Button
                      ...
                      variant="destructive"
                      size="icon"
                      className="absolute top-4 right-4 h-10 w-10 rounded-2xl shadow-xl backdrop-blur-md bg-destructive/80 hover:bg-destructive transition-all"
                      onClick={() => form.setValue('imageId', '')}
                    >
                      <X className="h-5 w-5" />
                    </Button>
                  </>
