      ...
      <div className="space-y-10 mb-16">
        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          <aside className="hidden lg:block w-[300px] shrink-0 space-y-8">
            ...
            <div className="bg-card/20 p-6 rounded-[4px] border border-white/5 space-y-6">
          ...
          <div className="flex-1 min-h-[600px] w-full">
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-8">
              {Array.from({ length: 6 }).map((_, i) => (
                <div
                  key={i}
                  className="flex flex-col space-y-5 p-4 rounded-3xl bg-card/20 border border-white/5"
                >
