...
export const PixelHero = () => {
    ...
    return (
      <section className="relative w-full overflow-hidden bg-background py-16 md:py-24 lg:py-32 flex justify-center items-center">
        ...
        <div className="animate-pulse flex flex-col items-center gap-6 relative z-10">
          ...
          <p className="text-muted-foreground font-mono uppercase tracking-widest text-sm font-semibold">
            Iniciando Motor de Promociones...
          </p>
        </div>
      </section>
    );
    ...
    return (
      <section className="relative w-full overflow-hidden bg-background py-16 md:py-24 lg:py-32">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center space-y-6">
          ...
          <h2 className="font-headline text-3xl md:text-5xl font-bold tracking-tight uppercase bg-clip-text text-transparent bg-gradient-to-r from-foreground to-muted-foreground">
            Nuevas ofertas próximamente
          </h2>
          <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto font-medium">
            Actualizamos nuestro catálogo regularmente. Vuelve pronto para descubrir nuevas
            promociones o explora nuestra tienda completa.
          </p>
          <div className="pt-4">
            <Button variant="outline" size="lg" asChild className="px-8">
              <Link href="/productos">
                Ir al catálogo completo <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
          </div>
        </div>
  ...
  return (
    <section className="relative w-full overflow-hidden bg-background py-6 md:py-8 lg:py-10 border-b border-white/5">
        ...
        >
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="flex flex-wrap gap-3">
              ...
              <Badge
                variant="outline"
                className="text-white/70 border-white/20 bg-white/5 backdrop-blur-md font-mono uppercase tracking-widest py-1.5 rounded-md hover:bg-white/10 transition-colors"
              >
            ...
            <div className="grid">
              <div
                className="col-start-1 row-start-1 invisible pointer-events-none select-none flex flex-col gap-4"
                aria-hidden="true"
              >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 pt-2">
              ...
              <Button variant="ghost" size="lg" className="w-full sm:w-auto px-8" asChild>
