          ...
          <div className="lg:hidden w-full flex flex-col gap-4">
            ...
            <Sheet>
              <SheetTrigger asChild>
                <Button
                  variant="outline"
                  className="h-12 border-primary/30 text-primary hover:bg-primary/10 transition-all font-bold uppercase tracking-widest text-[10px]"
                >
              ...
              <SheetContent
                side="left"
                className="w-[300px] sm:w-[500px] overflow-y-auto bg-card/95 backdrop-blur-2xl border-white/5 custom-scrollbar"
              >
                <SheetHeader className="mb-8">
                  <SheetTitle className="font-headline text-3xl font-bold text-white uppercase tracking-tighter">
                    Filtros Avanzados
                  </SheetTitle>
          ...
          <div className="flex-1 min-h-[600px] w-full">
            {loading ? (
              ...
              <div className="h-[500px] flex flex-col items-center justify-center text-center p-12 bg-card/10 rounded-2xl border-2 border-dashed border-white/10 animate-in zoom-in-95 duration-500">
                ...
                <p className="text-muted-foreground mt-3 max-w-sm leading-relaxed text-xs font-medium opacity-80">
                  No encontramos juegos con esos filtros. ¡Probá con otros!
                </p>
                <Button
                  onClick={resetFilters}
                  variant="outline"
                  className="mt-8 border-primary/30 text-primary font-bold uppercase tracking-widest text-[9px] h-11 px-6 rounded-lg hover:bg-primary/10 hover:text-primary hover:border-primary transition-all duration-300"
                >
                  Restablecer Filtros
                </Button>
              </div>
